...
bot_token = os.environ.get("bot_token", "8166897584:AAF2iZA2CBzVN-lS4T6-N7brNuV9VrNELE8")
custom_caption = os.environ.get("custom_caption", "`{file_name}`\n\n**Powered By - @Son_Goku_8**") # Here You Can Give Anything, if You Want Real File Name Then Use {file_name}
...
about_message = """
<b>• Name : <a href=https://t.me/Son_Goku_8>VJ AutoCaption</a></b>
<b>• Developer : <a href=https://t.me/Senpai_dxd>[VJ UPDATES]</a></b>
<b>• Language : Python3</b>
<b>• Library : Pyrogram v{version}</b>
<b>• Updates : <a href=https://t.me/Son_Goku_8>Click Here</a></b>
...
def start_buttons(bot, update):
    bot = bot.get_me()
    buttons = [[
        pyrogram.types.InlineKeyboardButton("Updates", url="t.me/Son_Goku_8"),
